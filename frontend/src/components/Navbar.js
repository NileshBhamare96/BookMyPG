        ...
        <nav className="navbar fixed-top navbar-expand-lg navbar-dark bg-gradient text-black fw-bold ">
         ...
         <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <Link className="nav-link active" aria-current="page" to="/">Home</Link>
            ...
            <>
            <li className="nav-item">
            <Link className="nav-link active" aria-current="page" to="/owners">Owner</Link>
            </li>
            <li className="nav-item">
            <Link className="nav-link active" aria-current="page" to="/users">Users</Link>
            </li>
            <li className="nav-item">
            <Link className="nav-link active" aria-current="page" to="/apartments">Appartment</Link>
            </li>
            <li className="nav-item">
          ...
          <Link className="nav-link active" aria-current="page" to="/ourteam">Our Team</Link>
           ...
           <li className="nav-item">
          <Link className="nav-link active" aria-current="page" to="/help">ChatBot</Link>
           </li>
           </>
           ):(
               <>
