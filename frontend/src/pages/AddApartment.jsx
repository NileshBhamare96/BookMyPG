...
console.log(pic4);
  return (
    <div className="container mt-5" style={{backgroundColor:"floralwhite"}}>
      <div className="title">Add Appartments</div>
      <form onSubmit={handleSubmit} >
        <div className="user-details">
          ...
          <div className="input-box">
            <span className="details">PG Room Photo 1</span>
            <input
              type="file"
          ...
          <div className="input-box">
            <span className="details">PG Room Photo 2</span>
            <input
              type="file"
              placeholder="First Photo"
          ...
          <div className="input-box">
            <span className="details">PG Room Photo 3</span>
            <input
              type="file"
              placeholder="First Photo"
          ...
          <div className="input-box">
            <span className="details">PG Room Photo 4</span>
            <input
              type="file"
              placeholder="First Photo"
